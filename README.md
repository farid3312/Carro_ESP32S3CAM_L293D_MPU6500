...
11- CarroV3_Final.ino cuenta con la implementacion basica del sensor hc-sr04 para la deteccion de colisiones y manda una advertencia al estar muy cercano, con esto el carro esta listo para salir a las pistas
